    ...
    <div class="container">
        <div class="row">
            ...
            <?php for ($all = 0; $all < count($donnees_qcm); $all++) : ?>
                ...
                ?>
                <div id="top" class="col-md-6 col-sm-12 p-3 header-jumper-section <?php echo $hideSectionByJumper; ?>" data-section="<?php echo $donnees_qcm[$all]->section_nom; ?>">
                        ...
                        <div data-tracer="<?php echo $donnees_qcm[$all]->section_nom; ?>" class="card card-questions shadow <?php echo $toShow ?> qst-ID-<?php echo $questions_reponses[$i]->question_id ?>  qst-<?php echo $i + 1 ?>" data-id="qst-<?php echo $i + 1 ?>">
                            ...
                            <div class="card-footer">
                                <p class="text-center p-3">
                                    <span><a href="#top" data-id="<?php echo $i ?>" class="btn btn-outline-primary page-prec" data-tracer="<?php echo $donnees_qcm[$all]->section_nom; ?>" style="text-decoration: none ; font-weight: bold;"><span class="text-prec">Question précédente</span><i class="fas fa-arrow-left arrow-left"></i></a></span>
                                    ...
                                    <span><a href="#top" data-totale="<?php echo count($donnees_qcm[$all]->questions); ?>" data-id="<?php echo $i + 2 ?>" class="btn btn-outline-primary page-suiv" data-tracer="<?php echo $donnees_qcm[$all]->section_nom; ?>" style="text-decoration: none ; font-weight: bold;"><span class="text-suiv">Question suivante</span><i class="fas fa-arrow-right arrow-right"></i></a></span>
                                </p>
